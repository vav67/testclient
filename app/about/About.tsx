    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          Благодаря электронному обучению ничто не стоит между вам&apos;и и 
          работой вашей мечты. Наши курсы и сообщество предоставят вам руководство, 
          поддержку и мотивацию, необходимые для полного раскрытия вашего потенциала 
          и становления квалифицированным программистом.
          <br />
          <br />
          ...
          sky&apos;s the limit.
          И так, чего же ты ждешь? Присоединяйтесь к семье электронного обучения 
          сегодня и давайт&apos;е вместе покорить индустрию программирования! 
          Благодаря нашим доступным курсам, информативным видеороликам и поддержке 
          сообщества не&apos;т предела.
        </p>
        <br />
        <span className="text-[22px]"> Имя главного &apos;s</span>
