// боковая панель на странице магазина
"use client";
...
type Props = {
 ...
 <RxDashboard size={30} title={" Dashboard"} color={`${active === 1 ? "crimson" : "#555"}`} />
 ...
 <FiShoppingBag size={30}  title={"orders"} color={`${active === 2 ? "crimson" : "#555"}`} />
    <h5  className={`hidden 800px:block pl-2 text-[18px] font-[400] ${
   ...
   <div className="relative group">  
      ...
      <h5
        className="absolute top-0 left-0 pl-2 text-[18px] font-[400] opacity-0   bg-[#dab40e]  bg-opacity-40
